            ...
            <div class="block rounded bordered" v-loading="isLoading" >
                ...
                <div class="block-content p-0">
                    <el-table :data="data" class="w-100" @sort-change="sortChange" header-cell-class-name="bg-body text-dark">
                        ...
                        <el-table-column prop="user.nama" label="Talent" sortable/>
                        <el-table-column prop="tanggal" label="tanggal" sortable/>
                        <el-table-column prop="waktu" label="Waktu" sortable/>
                        ...
                        <el-table-column label="Aksi" align="center" width="180">
                            <template #default="scope">
                                <a :href="route('admin.talent.show', {id : scope.row.id})" class="ep-button ep-button--primary">
