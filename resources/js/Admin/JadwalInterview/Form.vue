                        ...
                        <el-row :gutter="40">
                            <el-col :span="12">
                                <el-form-item label="Talent" :error="errors.user_id">
                                    <select-talent v-model="form.user_id" status="diterima"/>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
...
const setValue = () => {
    ...
    form.tanggal = props.data.tanggal;
    form.waktu = props.data.waktu;
    form.lokasi = props.data.lokasi;
    form.pewawancara = props.data.pewawancara_id;
...
const submit = () => {
    loading.value = true;
    let url = props.editMode ? route('admin.interview.jadwal.update', { id: props.data.id }) : route('admin.interview.jadwal.store');
